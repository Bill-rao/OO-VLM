...
# GRADIENT_ACCUMULATE
_C.TRAIN.GRADIENT_ACCUMULATE = 0

# is need to reset epoch
_C.TRAIN.IS_RESET_EPOCH = False
...
# Data Record options
# -----------------------------------------------------------------------------
_C.DATARECORDER = CfgNode()

_C.DATARECORDER.DATASPLIT = ""

_C.DATARECORDER.OUTPUT_FOLDER_PATH = './data_record/'

_C.DATARECORDER.GET_FEATURE_ENABLE = False

_C.DATARECORDER.TEST_FEATURE_ENABLE = False
...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "uniformer", "uniformerv2", "omnimae", "avion", "fusion", "coord"]
...
_C.FUSION.ENABLE = False

# tokenize max len
_C.FUSION.MAX_WORDS = 25

_C.FUSION.RGB_ENABLE = True

# RGB backbone
_C.FUSION.RGB_BACKBONE = "uniformerv2_b16"

# RGB feature dim
_C.FUSION.RGB_WIDTH = 0

# The path to the RGB pretrain model
_C.FUSION.RGB_PRETRAIN_PATH = ""

# The path to the language config path
_C.FUSION.LANGUAGE_CONFIG_PATH = ""

# The path to the language pretrain model
_C.FUSION.LANGUAGE_PRETRAIN_PATH = ""

# The name of pretrain language model
_C.FUSION.LANGUAGE_MODEL = ""  # bert roberta

_C.FUSION.LANGUAGE_TOKENIZER_DIR_PATH = ""

# The path to the coord pretrain model
_C.FUSION.COORD_PRETRAIN_PATH = ""

# The number of object class
_C.FUSION.OBJ_CLASS_NUM = 0

# The dimension of coord feature
_C.FUSION.COORD_FEATURE_DIM = 256

# The num of head of coord model
_C.FUSION.COORD_NUM_HEAD = 4

# The num of spatial layer
_C.FUSION.COORD_NUM_SPATIAL_LAYER = 3

# The num of temporal layer
_C.FUSION.COORD_NUM_TEMPORAL_LAYER = 3

# The num of frames of coord
_C.FUSION.COORD_NUM_FRAME = 32

#
_C.FUSION.EMBED_DIM = 512

_C.FUSION.QUEUE_SIZE = 57600

_C.FUSION.MOMENTUM = 0.995

_C.FUSION.ALPHA = 0.4

_C.FUSION.K_TEST = 64

_C.FUSION.NEGATIVE_ALL_RANK = False

# The num of Query tokens - it should be equal to num of vision tokens
_C.FUSION.NUM_QUERY_TOKEN = 2

_C.FUSION.NUM_COORD_RGB_TOKEN = 0
...
# The list of skip sample id
_C.DATA.SKIP_IDS = []

# The path to bbox anno directory
_C.DATA.PATH_TO_BBOX_ANNO_DIR = ""

# The path to recording samples directory
_C.DATA.PATH_TO_BBOX_SAMPLE_DIR = ""

# The number of frames of the bboxes
_C.DATA.NUM_BBOX_FRAMES = 32

# The number of bboxes per frame
_C.DATA.NUM_BBOXES = 4
...
# Label file path template.
_C.DATA.IMAGE_TEMPLATE = "{}_{:06d}.jpg"
